...
const ProductCard = ({image,price,productName,brand}) => {
  return (
    <div className="relative w-40 md:w-56 flexflex-col gap-2 cursor-pointer p-2">
      <div className="relative card md:h-56  overflow-hidden rounded-lg">
        <img
          ...
          alt=""
        />
        <p className="absolute bg-blue-600 text-xs md:text-sm font-semibold text-white py-2 bottom-[-100px] addtoCart duration-500 align-center w-full text-center">ADD TO CART</p>
      ...
      <div className="w-full text-center px-2 my-5 ">
